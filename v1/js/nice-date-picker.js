...
(function (global, factory) {
    ...
    niceDatePicker.prototype.getMonthData = function (year, month) {
        ...
        year = this.$params.year; //firstDay.getFullYear();
        ...
        var styleCls = '';
		var comp_date = '';
		var disabled_dates1 = this.$params.disabled_dates;
        for (var i = 0; i < 7 * 6; i++) {
            ...
            var thisMonth = month; 
			comp_date =  date + '-' + month + '-' + year; 
 			var net_res = disabled_dates1.indexOf(comp_date);
