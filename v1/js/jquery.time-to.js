...
(function (factory) {
    ...
    var defaults = {
        ...
        fontSize: '14px',             // font-size of a digit by pixels (0 - use CSS instead)
        ...
        width: 'auto',               // width of a digit area
        height: 'auto',              // height of a digit area
        gap: 0,                 // gap size between numbers
