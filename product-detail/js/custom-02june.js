...
$("#line-type .boardband-sec").click(function(e) {
    ...
    var priceValue = document.getElementById('customise-price').innerHTML;
    var newValue = parseInt(priceValue) + 2;
    document.getElementById('customise-price').innerHTML = newValue;
...
$(".extra-icons li a").click(function(e) {
    e.preventDefault();
    $(this).toggleClass('active');
...
$("#plan-type .plan-box").click(function() {
    $('html, body').animate({
        scrollTop: $("#line-type").offset().top
    }, 2000);
});    
